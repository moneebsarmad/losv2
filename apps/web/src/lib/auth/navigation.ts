...
> = {
  super_admin: [
    ...
    { label: 'Recognition Review', href: '/dashboard/admin/recognition-nominations', icon: 'admin' },
    { label: 'Recognition Analytics', href: '/dashboard/admin/recognition-analytics', icon: 'analytics' },
